...
public class Command_ineedhelp extends BukkitCommand<EFUtils> {

    @Override
    public boolean run(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        Bukkit.broadcastMessage(ChatColor.YELLOW + "NOTICE: " + sender.getName() + " - Needs admin assistance.");
        sender.sendMessage(ChatColor.GREEN + "Thank you for contacting the admins. A staff member will help you shortly. :)");
